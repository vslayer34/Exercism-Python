...
# URL: https://exercism.org/tracks/python/exercises/etl
'''
Instructions
...
def transform(legacy_data: dict) -> dict:
    return {letter.lower(): num for num in legacy_data for letter in legacy_data[num]}




# Test 1
display_task_name("I", "Etl > single letter")

display_example('legacy_data = {1: ["A"]}',
    'data = {"a": 1}'
)
